import{l as P,g as S,f as n,u as _}from"./utils-Doi09Ce6.js";import{P as q}from"./ProductData-DNMUPkWy.js";await P();const d=S(),a=document.querySelector("#checkout-items"),m=document.querySelector("#checkout-total"),s=document.querySelector("#place-order");if(!d||d.length===0)a&&(a.innerHTML="<p>Your cart is empty. Add items before checking out.</p>"),s&&(s.disabled=!0);else{const t=new q("tents");let r=0;const y=d.map(async e=>{try{const c=await t.findProductById(e.Id);if(!c)return null;const o=Number(e.FinalPrice||e.SuggestedRetailPrice||0),l=Number(e.quantity||1),u=o*l;r+=u;const i=document.createElement("li");return i.className="cart-card",i.innerHTML=`
